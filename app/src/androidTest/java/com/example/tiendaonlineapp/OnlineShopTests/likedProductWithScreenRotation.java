...
public class likedProductWithScreenRotation {
    ...
    public void likedProductTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.content), withText("Tempest Liquid Cooler 360 RGB Kit de Refrigeración Líquida Negro"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("Tempest Liquid Cooler 360 RGB Kit de Refrigeración Líquida Negro")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.content), withText("Tempest Liquid Cooler 360 RGB Kit de Refrigeración Líquida Negro"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class))),
                        isDisplayed()));
        textView2.check(matches(withText("Tempest Liquid Cooler 360 RGB Kit de Refrigeración Líquida Negro")));
